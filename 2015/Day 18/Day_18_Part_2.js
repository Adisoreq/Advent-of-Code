...
function turnOnCorners(board) {
    board.set(new Point(0, 0), 1);
    board.set(new Point(board.width - 1, 0), 1);
    board.set(new Point(0, board.height - 1), 1);
    board.set(new Point(board.width - 1, board.height - 1), 1);
}
