...
for (const line of processedInput) {
    
    totalMemoryChars += line.length;

    let encodedLine = '"' +
        line.replace(/\\/g, '\\\\').replace(/"/g, '\\"') +
        '"';

    totalCodeChars += encodedLine.length;
}

console.log()
console.log('Total code chars:', totalCodeChars)
console.log('Total memory chars:', totalMemoryChars)
console.log('Difference:', totalCodeChars - totalMemoryChars)