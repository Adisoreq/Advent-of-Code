...
function nextCorrectPassword(password) {
    let newPassword = nextPassword(password)

    while (!passwordCorrect(newPassword)) {
...
let password = nextCorrectPassword(input)
let newPassword = nextCorrectPassword(password)
